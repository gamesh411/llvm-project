...
// CHECK: c:@F@empty# defined in {{.*}}basic_function_marking.cpp
void empty() {}

void empty_already_noexcept() noexcept {}

// CHECK: c:@F@return_int# defined in {{.*}}basic_function_marking.cpp
...
// CHECK: c:@F@catches_all_thrown_exceptions# defined in {{.*}}basic_function_marking.cpp
...
// CHECK: c:@F@catches_all_thrown_exceptions_with_catch_all# defined in {{.*}}basic_function_marking.cpp
...
// implementation.
//
// CHECK-NOT: c:@F@calls_unknown_function# defined in {{.*}}basic_function_marking.cpp
...
//
// CHECK: c:@F@uses_builtin#I# defined in {{.*}}basic_function_marking.cpp
...
// implementation.
//
// CHECK-NOT: c:@F@uses_builtin_with_unknown#I# defined in {{.*}}basic_function_marking.cpp
...
//
// CHECK-NOT: c:@F@order_of_function_calls#I# defined in {{.*}}basic_function_marking.cpp
...
// c:@F@nested_try_catch# defined in {{.*}}basic_function_marking.cpp
...
//
// TODO: This is not detected as noexcept. Once fixed, add a check here for:
// c:@F@nested_try_catch_with_rethrow_catch_chain# in {{.*}}basic_function_marking.cpp
...
//
// TODO: This is not detected as noexcept. Once fixed, add a check here for:
// c:@F@nested_try_catch_with_rethrows# defined in {{.*}}basic_function_marking.cpp
