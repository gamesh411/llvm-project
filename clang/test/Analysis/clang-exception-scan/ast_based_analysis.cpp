...
// CHECK: c:@F@empty# defined in {{.*}}ast_based_analysis.cpp first declared in
...
// CHECK: c:@F@return_int# defined in {{.*}}ast_based_analysis.cpp first declared in
// {{.*}}ast_based_analysis.cpp
...
// CHECK-NOT: c:@F@calls_unknown_function# defined in {{.*}}ast_based_analysis.cpp first declared in
// {{.*}}ast_based_analysis.cpp
void calls_unknown_function() { function_with_unknown_implementation(); }

// Function that uses a builtin function
// CHECK: c:@F@uses_builtin#I# defined in {{.*}}ast_based_analysis.cpp first declared in
// {{.*}}ast_based_analysis.cpp
...
// CHECK-NOT: c:@F@uses_builtin_with_unknown#I# defined in {{.*}}ast_based_analysis.cpp first declared in
// {{.*}}ast_based_analysis.cpp
...
// CHECK-NOT: c:@F@order_of_function_calls#I# defined in {{.*}}ast_based_analysis.cpp first declared in
// {{.*}}ast_based_analysis.cpp
...
// CHECK: c:@F@nested_try_catch# defined in {{.*}}ast_based_analysis.cpp first declared in
// {{.*}}ast_based_analysis.cpp
...
// CHECK: c:@F@nested_try_catch_with_rethrow# defined in {{.*}}ast_based_analysis.cpp first declared in
// {{.*}}ast_based_analysis.cpp
...
// CHECK: c:@F@nested_try_catch_with_different_rethrow# defined in {{.*}}ast_based_analysis.cpp first declared in
// {{.*}}ast_based_analysis.cpp
...
// CHECK-NOT: c:@F@conditional_throw#I# defined in {{.*}}ast_based_analysis.cpp first declared in
// {{.*}}ast_based_analysis.cpp
...
// CHECK: c:@F@conditional_throw_always_caught#I# defined in {{.*}}ast_based_analysis.cpp first declared in
// {{.*}}ast_based_analysis.cpp
...
// CHECK-NOT: c:@F@rethrow_in_catch# defined in {{.*}}ast_based_analysis.cpp first declared in
// {{.*}}ast_based_analysis.cpp
...
// CHECK-NOT: c:@F@rethrow_different# defined in {{.*}}ast_based_analysis.cpp first declared in
// {{.*}}ast_based_analysis.cpp
...
// CHECK: c:@F@rethrow_caught# defined in {{.*}}ast_based_analysis.cpp first declared in
// {{.*}}ast_based_analysis.cpp
void rethrow_caught() {
  try {
    try {
...
// CHECK: c:@F@rethrow_different_caught# defined in {{.*}}ast_based_analysis.cpp first declared in
// {{.*}}ast_based_analysis.cpp
